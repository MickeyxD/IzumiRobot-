...
import IzumiRobot.modules.sql.chatbot_sql as sql
from coffeehouse.api import API
from coffeehouse.exception import CoffeeHouseError as CFError
from coffeehouse.lydia import LydiaAI
from IzumiRobot import AI_API_KEY, OWNER_ID, SUPPORT_CHAT, dispatcher
...
def check_message(context: CallbackContext, message):
    ...
    if message.text.lower() == "IzumiRobot":
        return True
    if reply_msg:
...
__help__ = f"""
Chatbot utilizes the CoffeeHouse API and allows IzumiRobot to talk and provides a more interactive group chat experience.
